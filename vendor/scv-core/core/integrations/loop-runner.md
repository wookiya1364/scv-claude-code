...
```
loop-runner "<host-config>/loop-template.md 를 읽고 실행 흐름을 따르라. 프로젝트 설정은 RALPH_PROMPT.md, 표준 명세는 scv/*.md, 보고는 /scv:report Claude Code 스킬을 사용한다." --max-iterations 35 --completion-promise "DONE"
```
